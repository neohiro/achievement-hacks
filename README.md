...
│   │   ├── earn.sh                   ← optional one-liner to earn it
...
|---|---|---|---|---|---|
| [starstruck](./_achievements/starstruck/README.md) | ⭐ Starstruck | Default → Gold | **Not yet** (85 stars, past Default) | Medium | Drive stars to a single repo |
| [pull-shark](./_achievements/pull-shark/README.md) | 🦈 Pull Shark | Default → Gold | **Not yet** (12+ merged PRs) | Easy | Keep merging PRs |
| [pair-extraordinaire](./_achievements/pair-extraordinaire/README.md) | 👥 Pair Extraordinaire | Default → Gold | **Earned** ✅ (PR #8) | Trivial | Add `Co-authored-by:` to one merged PR |
| [galaxy-brain](./_achievements/galaxy-brain/README.md) | 🧠 Galaxy Brain | Default → Gold | **In progress** (Q&A #7 created) | Medium | Enable Discussions, answer a question, mark it accepted |
...
## Security vulnerabilities filed

6 vulnerability reports (VULN-001 to VULN-006) have been filed as GitHub Issues documenting the automation-surface risks in achievement awarding:

- [#1 VULN-001 Quickdraw](./issues/1) — sub-5-minute close loop
- [#2 VULN-002 YOLO](./issues/2) — admin-override merge bypass
- [#3 VULN-003 Heart On Your Sleeve](./issues/3) — mass reaction automation
- [#4 VULN-004 Pair Extraordinaire](./issues/4) — co-author trailer farming
- [#5 VULN-005 Pull Shark](./issues/5) — PR count farming
- [#6 VULN-006 Galaxy Brain](./issues/6) — self-answered Q&A farming

See [`SECURITY.md`](./SECURITY.md) for the full analysis and proposed defenses.
